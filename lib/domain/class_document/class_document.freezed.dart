...
abstract class $ClassDocumentCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String description, int count});
}
...
class _$_ClassDocument implements _ClassDocument {
  const _$_ClassDocument(
      {this.title = '', this.description = '', this.count = 0});
  ...
  @override
  String toString() {
    return 'ClassDocument(title: $title, description: $description, count: $count)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, description, count);
...
abstract class _ClassDocument implements ClassDocument {
  const factory _ClassDocument(
      {final String title,
      final String description,
      final int count}) = _$_ClassDocument;
