...
variant_for_slice()
{
  ...
  "BoringSSL-GRPC.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "FBLPromises.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "FBLPromises.xcframework/tvos-arm64")
    echo ""
    ;;
  "FBLPromises.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "FBLPromises.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "FBLPromises.xcframework/ios-arm64")
    echo ""
    ;;
  "FBLPromises.xcframework/ios-arm64_x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
...
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/BoringSSL-GRPC.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/FBLPromises.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/FirebaseFirestore.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/FirebaseFirestoreSwift.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/Libuv-gRPC.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/abseil.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/gRPC-C++.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/gRPC-Core.xcframework" "FirebaseFirestore/Base" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/leveldb-library.xcframework" "FirebaseFirestore/WithLeveldb" "framework" "macos-arm64_x86_64"
